...
RSpec.describe Mrml::Rails, type: :mailer do
  describe 'without layout' do
    ...
    describe '#partial_email' do
      let!(:mail) { MrmlTestMailer.partial_email('Random User').deliver_now }
  ...
  describe 'with layout' do
    describe '#normal_email' do
      let!(:mail) { MrmlLayoutTestMailer.normal_email('Random User').deliver_now }
    ...
    describe '#partial_email' do
      let!(:mail) { MrmlLayoutTestMailer.partial_email('Random User').deliver_now }
